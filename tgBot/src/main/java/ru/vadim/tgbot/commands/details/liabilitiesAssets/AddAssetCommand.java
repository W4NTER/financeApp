...
import static ru.vadim.tgbot.utils.constants.CommandsConstants.ADD_ASSET_COMMAND;
import static ru.vadim.tgbot.utils.constants.CommandsConstants.ADD_ASSET_COMMAND_DESCRIPTION;
import static ru.vadim.tgbot.utils.constants.Constants.ASSETS_LIABILITIES_MENU;

@Component
public class AddAssetCommand implements Command<SendMessage, SendResponse> {
    @Override
